...
// Discovered macro files: active_setting_lore, candidate_entries, candidate_registry, current_running_recap, earliest_allowed_break, entry_name, existing_content, extracted_sl, filtered_recap, lorebook_entry_lookup_synopsis, lorebook_entry_types, lorebook_entry_types_with_guidance, message, messages, minimum_scene_length, new_content, new_entries, new_entry, prefill, scene_messages, scene_recaps, stage2_recap
const macroFiles = [
  "active_setting_lore",
  "candidate_entries",
  "candidate_registry",
