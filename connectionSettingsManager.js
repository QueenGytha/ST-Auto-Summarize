 ...
 */
async function getCurrentConnectionSettings() /*: Promise<{+connectionProfile?: string, +completionPreset?: string}> */ {
    ...
    const settings = {};
    if (connectionProfile != null) (settings /*: any */).connectionProfile = connectionProfile;
    if (completionPreset != null) (settings /*: any */).completionPreset = completionPreset;

    return (settings /*: {+connectionProfile?: string, +completionPreset?: string} */);
}
 ...
 */
function saveConnectionSettingsState(state /*: {+connectionProfile?: string, +completionPreset?: string} */) /*: void */ {
    try {
        if (!chat_metadata.autoSummarize) {
            chat_metadata.autoSummarize = ({} /*: any */);
        }
 ...
 */
function getSavedConnectionSettingsState() /*: ?{+connectionProfile?: string, +completionPreset?: string} */ {
    try {
 ...
 */
function clearSavedConnectionSettingsState() /*: void */ {
    try {
 ...
 */
async function restoreConnectionSettingsIfNeeded() /*: Promise<boolean> */ {
