...
// $FlowFixMe[signature-verification-failure]
function sanitizeNameSegment(text /*: string */) /*: string */ {
...
// $FlowFixMe[signature-verification-failure]
export function getUniqueLorebookName(baseName /*: string */, existingNames /*: ?Array<string> */) /*: string */ {
    const existing = Array.isArray(existingNames) ? existingNames : [];
    let chosen /*: string */ = baseName;
