# Active/Inactive Entry Snapshots - Implementation Details
...
**For complete documentation, refer to Feature #181:**
...
This feature (Feature #159) is identical to Feature #181. Both provide complete historical tracking of lorebook entries for every message generation. See [Feature #181 Implementation](../active-and-inactive-entry-snapshots/implementation.md) for full documentation.
